...
export const Route = createFileRoute("/sgs-admin/_admin/payments")({ component: PaymentsPage });
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-xl">
        ...
        <DialogFooter>
          <Button asChild variant="outline">
            <Link to="/sgs-admin/invoices/$paymentId/print" params={{ paymentId: payment.id }} target="_blank">
