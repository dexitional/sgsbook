...
export const Route = createFileRoute("/sgs-admin/_admin/requests")({ component: RequestsPage });
          ...
          <div className="space-y-3">
            ...
            <DialogFooter>
              <Button asChild variant="outline">
                <a href={`/sgs-admin/requests/${request.id}/print`} target="_blank" rel="noreferrer">
