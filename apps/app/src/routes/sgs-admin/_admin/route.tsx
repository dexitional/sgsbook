...
export const Route = createFileRoute("/sgs-admin/_admin")({
...
function AdminLayout() {
  ...
  useEffect(() => {
    if (!isLoading && isError) navigate({ to: "/sgs-admin/login" });
...
function SignOutItem() {
  ...
  return (
    <DropdownMenuItem
      onClick={() => logout.mutate(undefined, { onSuccess: () => navigate({ to: "/sgs-admin/login" }) })}
    >
