...
export const Route = createFileRoute("/sgs-admin/invoices/$paymentId/print")({ component: PrintPaymentReceiptPage });

function PrintPaymentReceiptPage() {
  ...
  if (!payment) {
    return <div className="flex min-h-screen items-center justify-center text-destructive">Receipt not found.</div>;
  }
      ...
      <div className="rounded-xl border border-border bg-card p-10 shadow-sm print:border-0 print:shadow-none">
        ...
        <div className="grid grid-cols-2 gap-6 py-6">
          ...
          <div className="text-right">
            ...
            {payment.paidName && <p className="text-sm text-muted-foreground">Paid by: {payment.paidName}</p>}
          </div>
        </div>
