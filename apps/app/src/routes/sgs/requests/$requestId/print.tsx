...
import { getRequestInvoice } from "#/server/customer";
import type { RequestStatus } from "#/lib/customer-types";
import { asset } from "#/lib/asset";

export const Route = createFileRoute("/sgs/requests/$requestId/print")({ component: PrintRequestInvoicePage });
...
function PrintRequestInvoicePage() {
  ...
  const invoice = useQuery({
    ...
    queryFn: () => getRequestInvoice({ data: { requestId } }),
  });
